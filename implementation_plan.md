...
## Goal Description
Implement the new "balanced" scoring system as agreed in the `scoring_suggestion.md` specification. The goal is to increase the weight of the Championship prediction (from 87 to 200 points) and sharpen the Race Weekend scoring (from 12-9-7... to 25-18-15...) to better reward accuracy and importance.
...
- Update `calculateChampionshipPoints`:
  - 1st place: 100 pts (was 37)
  - 2nd place: 50 pts (was 25)
  - 3rd place: 50 pts (was 25)
  - Total: 200 pts
...
### Manual Verification
- Review the `scripts/test-scoring-simple.js` output to ensure all checks pass with the new values (e.g., verifying a perfect weekend score is 225 instead of 108).

  ...
  return (
    <main className="min-h-screen p-4 md:p-8 font-sans text-white">
      <div className="max-w-4xl mx-auto">
        ...
        {showWelcome && !existingPrediction && (
          <div className="mb-8 p-6 bg-gradient-to-r from-blue-900/40 to-blue-800/20 border-l-4 border-blue-500 rounded-lg shadow-lg animate-in fade-in slide-in-from-top-4 duration-700">
            <h2 className="text-2xl font-display font-black italic uppercase text-white mb-2">
              Welcome to the Paddock! 🏁
            </h2>
            <p className="text-gray-300 text-lg">
              Before you can access the dashboard, you must submit your <span className="text-white font-bold">Championship Prediction</span>.
              Who will stand on the podium at the end of the season?
            </p>
          </div>
        )}
